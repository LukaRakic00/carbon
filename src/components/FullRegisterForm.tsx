      ...
      <Card className="bg-gray-800 border-gray-700 relative w-full max-w-2xl mx-auto rounded-3xl p-6 overflow-y-auto max-h-[95vh]">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardContent className="space-y-4 sm:space-y-6">
              ...
              <div className="border-2 border-dashed border-gray-600 rounded-lg p-8 text-center">
                ...
                <label htmlFor="invoice-upload" style={{ cursor: 'pointer' }}>
                  <input
                    ...
                    style={{ display: 'none' }}
                  />
                  <span className="cursor-pointer bg-gray-200 px-4 py-2 rounded hover:bg-gray-300 inline-block">
                    Izaberite fajl
                  </span>
                </label>
                {invoiceFile && (
            ...
            <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-base sm:text-lg py-2 sm:py-3 rounded-lg mt-2" disabled={loading}>
